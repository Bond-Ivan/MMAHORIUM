...
function MainTournament(): ReactElement {
    ...
    useEffect(() => {
        const targetDate = new Date("2026-04-12T02:00:00+03:00").getTime();
    ...
    return (
        <section className={styles.container}>
            <div className={styles.infoBlock}>
                ...
                <h2 className={styles.eventName}>UFC 327: <br />Иржи Прохазка vs Карлос Ульберг</h2>
                <p className={styles.eventWeight}>
                    ...
                    {UfcWeightClass.LightHeavyweight}
                </p>

                <div className={styles.fighters}>
                    <div className={styles.firstFighter}>
                        <h3 className={styles.fighterName}>🇨🇿Прохазка</h3>
                        <p className={styles.fighterRaiting}>32-5-1</p>
                    </div>
                    <div className={styles.badge}>
                        VS
                    </div>
                    <div className={styles.secondFighter}>
                        <h3 className={styles.fighterName}>🇳🇿Ульберг</h3>
                        <p className={styles.fighterRaiting}>14-1-0</p>
                    </div>
                </div>
