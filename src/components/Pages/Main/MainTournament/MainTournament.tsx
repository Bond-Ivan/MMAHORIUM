...
function MainTournament(): ReactElement {
    ...
    useEffect(() => {
        const targetDate = new Date("2026-04-05T02:00:00+03:00").getTime();
    ...
    return (
        <section className={styles.container}>
            <div className={styles.infoBlock}>
                ...
                <h2 className={styles.eventName}>UFC FIGHT NIGHT: <br />Moicano VS. Duncan</h2>
                <p className={styles.eventWeight}>
                    ...
                    {UfcWeightClass.Lightweight}
                </p>

                <div className={styles.fighters}>
                    <div className={styles.firstFighter}>
                        <h3 className={styles.fighterName}>🇧🇷Moicano</h3>
                        <p className={styles.fighterRaiting}>20-7-1</p>
                    </div>
                    <div className={styles.badge}>
                        VS
                    </div>
                    <div className={styles.secondFighter}>
                        <h3 className={styles.fighterName}>🏴󠁧󠁢󠁳󠁣󠁴󠁿Duncan</h3>
                        <p className={styles.fighterRaiting}>15-2-0</p>
                    </div>
                </div>
