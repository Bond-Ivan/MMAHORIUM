...
const INITIAL_MESSAGE: Message = {
    ...
    content:
        ...
        "- дать прогноз не как сухой бот, а как свой человек из мира UFC.\n\n" +
...
const QUICK_ACTIONS: QuickAction[] = [
    {
        ...
        prompt:
            "Расскажи про Конора Макгрегора в ярком фирменном стиле: путь, лучшие годы, менталка, плюсы, минусы и влияние на UFC.",
        emoji: "🥊",
        accent: "orange",
    },
    {
        ...
        const mockAnswer =
            lowerPrompt.includes("хабиб") || lowerPrompt.includes("ферг")
                ? "## Хабиб vs Тони — бой, который стал мифом\n" +
                  "Брат, это не просто матчап, это **многолетнее проклятие UFC**.\n\n" +
                  "**По стилям:**\n" +
                ...
                ? "## Конор Макгрегор — поп-звезда и снайпер\n" +
                  "Брат, Конор — это не просто боец, это **культурный удар по UFC**.\n\n" +
                ...
                : "## Разбор готов\n" +
                  "Брат, тут уже чувствуется мясо и нормальный потенциал для UFC Oracle.\n\n" +
                  "**Что я вижу:**\n" +
                    ...
                    <div className={styles.heroContent}>
                        <div className={styles.heroText}>
                            ...
                            <p className={styles.subtitle}>
                                ...
                                dream fights, симуляции по раундам и прогнозы в фирменном UFC-вайбе.
                            </p>
